        ...
        <div className="w-11/12 mt-96 mb-36 mx-auto border border-solid p-1 md:w-3/5 p-5">
           ...
           <div className="flex flex-wrap content-end w-11/12 mx-auto mt-10 mb-5">
            <div className="w-full p-1 mb-2 sm:w-1/2">
                ...
                <input className="border-blue-400 border-b-2 px-4 py-2 bg-gray-100 w-full text-md text-gray-700" type="text" id="fname" name="name" value={name}/><br/>
            </div>
            <div className="w-full p-1 mb-2 sm:w-1/2">
            ...
            <div className="w-full p-1 mb-2 sm:w-1/2 mb-4">
                ...
                <input className="border-blue-400 border-b-2 px-4 py-2 bg-gray-100 w-full text-md text-gray-700" type="email" id="fname" name="fname" value={bankNumber}/><br/>
            </div>
           </div>
