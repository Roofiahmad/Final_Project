...
export default function RelatedCampaign(props) {
  ...
  useEffect(() => {
    axios
      .get(
        `https://talikasih.kuyrek.com:3001/campaign/category?category=${props.category}&page=1&limit=3`
      )
      .then((response) => {
        ...
        {relatedCampaignData.map((campaign) => {
          return (
            <Link
              ...
              className="font-bold mt-4 item-clicked"
            >
                ...
                <div className="w-5/6 mx-auto pb-4 pt-2">
                  ...
                  <div className="h-3 relative max-w-xl rounded-full overflow-hidden mb-8">
                    ...
                    <div
                      ...
                      style={{
                        width:
                          (campaign.total_donation_rupiah / campaign.goal) *
                            100 +
                          "%",
                      }}
                    ></div>
